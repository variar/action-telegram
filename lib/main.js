...
(function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield _sendMessage(botToken, chatId, commitHash, commitActor, comment, jobStatus, skipSuccess);
 ...
 */
function _sendMessage(botToken, chatId, commitHash, commitActor, comment, jobStatus = 'success', skipSuccess = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const text = `${icon} ${workflow} *${jobStatus}* -- commit ${commitHash} by *${commitActor}* ${comment}`;
